...
lang["#MISSION_GIVER_STARTER_GREET_NEW"] = "¡Hey! Parece que estas perdido y confuso. Si no sabes lo que hacer por aquí, te puedo ayudar a instalarte si estás dispuesto a hacer algunass cosas. Lo más probable es que no te lleve mucho tiempo. Por otro lado,si solamente buscas trabajo, te sugiero que vayas al pueblo que está en el alto de la colina no muy lejos de aquí, solo sigue la carretera y gira a la izquierda en el barranco. ¡No deberías perderte!.\n\n\n\n[ Esta es uan serie de tareas para que el jugador empieze. No son necesarias que se completen , pero es recomendada para aquellos que son nuevos y puede ofrecer un pequeño empujón inicial. ]"
...
lang["#MISSION_GIVER_REDMAN_GREET_NEW"] = "Bienvenido a la ciudad, extraño. No parece que sepas mucho de lo que está pasando por aquí pero si buscas trabajo que hacer necesito gente que esté dispuesta a hacer algunas tareas. Asumiendo que ese es el por qué estás aquí,puedo intentar encontrar algo que sea más adecuado para alguien de tu habilidad. Si buscas Trabajos Publicos, tenemos un tablón a la entrada del pueblo en el que permitimos a la gente fijar carteles de trabajos para los que necesitan ayuda de otra gente.\n\n\nDe todas formas, aquí tienes algunas tareas que puedes hacer."
lang["#MISSION_GIVER_REDMAN_GREET_N100"] = ". Probablemente no sea bueno para ti, pero eres conocido por esta zona. Sabes bien que solo unos pocos van a confiar en ti pero estoy dispuesto a permitirte arreglarlo, tal y como hago con otros. Puedes empezar encargándote de algunas cosas por la zona.\n\n\nAquí tienes una lista de tareas."
lang["#MISSION_GIVER_REDMAN_GREET_0"] = "Bienvenido, habitante del Yermo. No parece que estes aquí para comerciar con alguna cosa, ¿Estás buscando algún trabajo?. Quizás tenga algo de lo que te puedas encargar.\n\n\nAqui tienes una lista de tareas con las que podrías ayudar."
lang["#MISSION_GIVER_REDMAN_GREET_100"] = "Hey $playername, espero que todo te esté yendo bien. Si estás buscando por cosas que hacer, quizás tenga un par de cosas para ti. También estoy considerando buscar más trabajos exclusicamente para ti ya que eres muy útil por esta zona.\n\n\nAquí tienes una lista con tareas."
lang["#MISSION_GIVER_REDMAN_GREET_200"] = ""
--Isaac (Salt Wells)
lang["#MISSION_GIVER_ISAAC"] = "Isaac"
lang["#MISSION_GIVER_ISAAC_SUBTITLE"] = "Caravana Crimson"
lang["#MISSION_GIVER_ISAAC_GREET_NEW"] = "Bienvenido a la ciudad, forastero. Espero que estés aquí con buenas intenciones. En realidad, hablando de buenas intenciones, necesitamos ayuda con algún trabajo si estás dispuesto a echar una mano. Necesitamos algunos materiales para el comercio y el transporte, si estás dispuesto a ayudar con eso. Te daré algo de dinero si quieres ayudar. Aquí hay una lista de cosas con las que necesito ayuda."
lang["#MISSION_GIVER_ISAAC_GREET_N50"] = "Oye, oye, oye, ¡Cuidado con tu próximo paso, amigo! ¡¿De acuerdo?! No me gustas y quiero que lo sepas, pero eso no te hace absolutamente inútil para mí. Todavía puedo necesitar ayuda con algunas cosas y es probable que seas la única persona que puede hacerlas en esta ciudad. Si quieres hacer algo, te asignaré algunos encargos ¡Pero anda con ojo!.\n\n\n Aquí tienes una lista de tareas."
lang["#MISSION_GIVER_ISAAC_GREET_0"] = "Hola, $playername.  Quizás tenga algunas tareas de las que te puedas encargar mientras estás por aquí.\n\n\nAquí tienes una lista de encargos."
lang["#MISSION_GIVER_ISAAC_GREET_50"] = "¿Qué pasa, $playername? ¡ Me alegro de ver una cara amigable por aquí, a pesar de estar en un agujero infernal. Es difícil encontrar a alguien como tú, en quien se puede confiar. Quizás tenga algunas cosas que puedes hacer por aquí si estás interesado.\n\n\n Aquí tienes una lista de tareas incompletas."
...
lang["#MISSION_GIVER_JACKSON_GREET_NEW"] = "¡Hey! Ya que estás por aquí,mi grupo y yo necesitamos ayuda con unas cosas, por si estás pensando en quedarte por aquí un tiempo.\n\n\nEsto es con lo que necesitamos ayuda, por si te interesa."
--Susan (Paso Montañoso)
lang["#MISSION_GIVER_SUSAN"] = "Susan" --Disponible cuando el jugador complete la misión: Desarrollo (Redman)
lang["#MISSION_GIVER_SUSAN_SUBTITLE"] = "República de Nueva California"
lang["#MISSION_GIVER_SUSAN_GREET_UNKNOWN"] = "Saludos, extraño. Ahora mismo estoy ocupada. Si no te importa..."
lang["#MISSION_GIVER_SUSAN_GREET_NEW"] = "Hola, $playername .  Hemos hablado hace poco con Redman y nos ha dicho que te enviaba para que nos ayudes con algunas cosas. Tengo una lista de cosas con las que nos podrías prestar ayuda y posiblemente en el futuro podamos seguir trabajando juntos.\n\n\nAquí está la lista de tareas con las que nos puedes ayudar."
...
--Xanthan (Tierras de la ceniza)
lang["#MISSION_GIVER_CHALLENGER"] = "Xanthan"
lang["#MISSION_GIVER_CHALLENGER_SUBTITLE"] = "Retador del Yermo"
lang["#MISSION_GIVER_CHALLENGER_GREET_NEW"] = "Hey,¿Te consideras un verdadero superviviente? Creo que hay mucha gente que subestima lo que es un verdadero superviviente. Mi nombre es Xanthan, o como mucha gente me conoce, 'El Retador del Yermo'. Si realmente quieres provar tu valía para la gente de esta zona y para mí, aquí tengo una lista de tareas que puedes hacer. Para que lo sepas, no será fácil pero se te pagará bien por ello.\n\n\nAquí tienes más retos que puedes intentar realizar."
lang["#MISSION_GIVER_CHALLENGER_GREET"] = "Hola de nuevo, $playername. Si sigues buscando más retos,tengo algunos disponibles.\n\n\nAquí tienes una lista de retos que aun no se han realizado."
--Dev Test (Tablón)
lang["#MISSION_BOARD_TEST"] = "Tablón de prueba"
...
--Salt Wells (Cartel)
lang["#MISSION_BOARD_SALTWELLS"] = "Tablón de misiones de Salt Wells"
lang["#MISSION_BOARD_SALTWELLS_SUBTITLE"] = "Tareas y trabajos"
lang["#MISSION_BOARD_SALTWELLS_GREET"] = "Este tablón contiene varios papeles con trabajos para gente que busca contratar los servicios de otros en el área. Puedes aceptar cualquier trabajo para el que cumplas las condiciones.\n\n\nLa lista de trabajos disponibles está debajo."
--Tierras de la ceniza (Tablón)
lang["#MISSION_BOARD_ASHLANDS"] = "Tablón de misiones de las Tierras de la ceniza"
lang["#MISSION_BOARD_ASHLANDS_SUBTITLE"] = "Tareas y trabajos"
lang["#MISSION_BOARD_ASHLANDS_GREET"] = "Este tablón contiene varios papeles con trabajos para gente que busca contratar los servicios de otros en el área. Puedes aceptar cualquier trabajo para el que cumplas las condiciones.\n\n\nLa lista de trabajos disponibles está debajo."
--Yolla Bolly (Cartel)
lang["#MISSION_BOARD_YOLLA"] = "Tablón de misiones de Yolla Bolly"
lang["#MISSION_BOARD_YOLLA_SUBTITLE"] = "Tareas y trabajos"
lang["#MISSION_BOARD_YOLLA_GREET"] = "Este tablón contiene varios papeles con trabajos para gente que busca contratar los servicios de otros en el área. Puedes aceptar cualquier trabajo para el que cumplas las condiciones.\n\n\nLa lista de trabajos disponibles está debajo."
...
lang["#SALVAGE_INFO"] = "Recupera $amount vehículos."
...
lang["#MISSION_STARTER_NEWAROUNDHERE"] = "Nuevo aquí"
lang["#MISSION_STARTER_NEWAROUNDHERE_DESC"] = "Entonces empezemos con algo básico para ti. Obviamente, el Yermo es un lugar muy peligroso,lleno de mutantes y otras cosas.No todo es hostil,pero hay un buen número de personas que te robarán o te disparaán, que es para lo que uno debe estar preparado. Tu primera misión es simple. Me gustaría saber si puedes rebuscar cosas o no. Bajando la colina hay un pueblo pequeño,busca por la zona contenedores o cajas, y recoge todo lo que puedas encontrar."
lang["#MISSION_STARTER_NEWAROUNDHERE_HINT"] = "Rebusca en los containers de  Salt Wells. Puedes buscar contenedores dentro de pueblos, edificios u otras localizaciones."
lang["#MISSION_STARTER_NEWAROUNDHERE_COMPLETE"] = "Es algo bueno que sepas todos los pasos básicos."

lang["#MISSION_STARTER_WASTELANDREPO"] = "Yermo Repo"
lang["#MISSION_STARTER_WASTELANDREPO_DESC"] = "¡Has vuelto!. De todas formas, tu siguiente misisón.Mientras estés rebuscando, es probable que encentres viejos y quemados vehículos. Quizás te preguntes qué puedes hacer con ellos y la respuesta es nada. En ocasiones tienen algunas sobras pero a parte de eso no se pueden usar para nada más. Lo que la mayoría de la gente hace es desmontarlos buscando chatarra, que realmente tiene un mejor propósito. Es simple, necesito que vayas y me demuestres que eres capaz de desmontar algunos de esos viejos coches con tus propias manos."
lang["#MISSION_STARTER_WASTELANDREPO_HINT"] = "Desguazar vehículos en Salt Wells.Puedes desmontar vehículos atacándolos con tus propais manos o con armas cuerpo a cuerpo. Llaves de tuvo o palancas son generalmente buenas para desguazar. Vehículos que se puedan desguazar se pueden encontrar en las carreteras o en sus proximidades."
...
lang["#MISSION_STARTER_GIFTSFROMGAIA_DESC"] = "Ahora, para algo que necesita un toque más delicado. En el yermo hay plantas que crecen libremente, plantas como las Broc, Jalapeños, Cactus de barril, Yucca o la raiz de Xander. Estas plantas se pueden emplear para crear múltiples remedios medicinales y muchas recetas culinarias. Ve y recolecta algunas plantas, no importa lo que sean, solo necesitas saber para qué se usan."
lang["#MISSION_STARTER_GIFTSFROMGAIA_HINT"] = "Recolecta cualquier planta en Salt Wells. Las plantas útiles generalmente crecen en los espacios abiertos en el Yermo.Revisa las rocas cercanas y otras estructuras. También se pueden encontrar cerca de zonas con vegetación."
lang["#MISSION_STARTER_GIFTSFROMGAIA_COMPLETE"] = "Bien, bien. Ten esto y habla conmigo cuando quieras saber qué hacer con ello."

lang["#MISSION_STARTER_POWDERINTHEWOUND"] = "Polvo en la herida"
lang["#MISSION_STARTER_POWDERINTHEWOUND_DESC"] = "¿Ya te has encontrado con algún mutante? Probablemente no pero cuando lo hagas seguramente querrás algo para curarte después de la pelea. Bueno, eso es si sigues con vida.De todas formas, te di un poco de raiz de Xander y flores de Broc en tu última misión por lo que quiero que lo combines para hacer unos polvos curativos."
lang["#MISSION_STARTER_POWDERINTHEWOUND_HINT"] = "Crear polvos curativos. Puedes crear miscelaneos en las fogatas, sobre todo comidas. Las fogatas suelen encontrarse en los campamentos u otros puntos de interés."
lang["#MISSION_STARTER_POWDERINTHEWOUND_COMPLETE"] = "Probablemente vayas a hacer muchos por lo que es un truco muy útil que debes aprender."

lang["#MISSION_STARTER_TOTALBREAKDOWN"] = "Despieze completo"
lang["#MISSION_STARTER_TOTALBREAKDOWN_DESC"] = "Vale, viendo que ya sabes usar la hoguera imagino que ya nos podemos mover un poco. Tengo una pregunta para ti ¿Sabes cómo se usa una mesa de trabajo? Casi todo el mundo aquí sabe cómo funciona, principalmente para fabricar algunas cosas que usarán eventualmente. Es realmente muy útil saber cómo se usan. Esto no debería ser difícil, pero enséñame cómo eres capaz de desmantelar algo en la mesa de trabajo."
lang["#MISSION_STARTER_TOTALBREAKDOWN_HINT"] = "Desmonta un objeto. Puedes desmontar objetos en la mesa de trabajo. LAs mesas de trabajo se encuentran generalmente en pueblos y de vez en cuando se pueden encontrar en zonas desoladas. Solo ciertos objetos se pueden desmontar, como latas de estaño o portapepeles."
lang["#MISSION_STARTER_TOTALBREAKDOWN_COMPLETE"] = "Bien, crear cosas no debería ser tan fácil como desmontarlas."
lang["#MISSION_STARTER_TOTALBREAKDOWN_INFO"] = "Desmonta $amount objetos."

lang["#MISSION_STARTER_FOODPREPARER"] = "Preparador de comida"
lang["#MISSION_STARTER_FOODPREPARER_DESC"] = "¡Bien!¡Has vuelto probablemente para hacer otra cosa!. Estoy intentando descubrir una cosa yo mismo, dame un segundo... Ahora que lo pienso, tengo una idea. Puedo enseñarte un truco que mi viejo grupo me enseñó cuando estaba con ellos when. Encuentra piernas de mantis... En buenas condiciones, por supuesto, y no hagas preguntas"
lang["#MISSION_STARTER_FOODPREPARER_HINT"] = "Obten patas de Mantis. He escuchado que un cazador local siempre tiene algunas almacenadas.Puedes llegar hasta allí siguiendo la carretera hasta la señal de Nevada 164. Las Mantis son débiles por lo que si encuentras alguna puedes matarla y arrancarle las patas."
lang["#MISSION_STARTER_FOODPREPARER_COMPLETE"] = "Vale, tienes una pierna. Ten estas también."

lang["#MISSION_STARTER_JUSTADDFIRE"] = "Simplemente añade fuego"
lang["#MISSION_STARTER_JUSTADDFIRE_DESC"] = "Quiero que vayas a la hoguera que hay en esa esquina y cocines la pata de Mantis. Te enseñaré qué ingredientes le añado yo."
lang["#MISSION_STARTER_JUSTADDFIRE_HINT"] = "Cocina una pata de Mantis. Puedes cocinar comida en las hogueras. Las hogueras se pueden encontrar en pueblos y otros puntos de interés."
lang["#MISSION_STARTER_JUSTADDFIRE_COMPLETE"] = "¿Qué tal saben?¿Ya te la has comido?"

lang["#MISSION_STARTER_GHOULDUEL"] = "Duelo necrófago"
lang["#MISSION_STARTER_GHOULDUEL_DESC"] = "Parece que estás preparado así que considera esto tu examen final. Tenemos unos cuantos necrófagos rondado por la zona no muy lejos de aquí y para probar tu valía quiero que vayas allí y te encarges de ellos. Deberías tener un arma, por si aun no te has enterado, pero quiero que vayas y destripes unos cuantos por mi."
lang["#MISSION_STARTER_GHOULDUEL_HINT"] = "elimina cualquier tipo de necrófago salvaje en Salt Wells. Los Necrófagos salvajes se pueden encontrar fácilmente en ruinas,edificios destrozados y en localizaciones abandonadas. Son débiles contra armas de fuego o golpes. Ten cuidado con los necrófagos saqueadores o los hinchados, son más peligrosos que los otros."
lang["#MISSION_STARTER_GHOULDUEL_COMPLETE"] = "¡Hah!¡Se han llevado su merecido! Lo harás bien en el Yermo!."
...
lang["#MISSION_REDMAN_NATURALREMEDIES_DESC"] = "Este es un trabajo bastante sencillo para tu nivel de experiencia. Solemos tener escuadrones de patrulla que suelen meterse en tiroteos, ya sea con Asaltantes o Mutantes y necesitamos tener suministros listos para situaciones como esa. Desafortunadamente, nos estamos quedando sin medicinas. Esto debería ser una petición bastante simple: Necesito que vayas a reunir algunas raíces de Xander y flores de Broc. Tenemos el resto de los materiales para hacer algunos estimulantes, así que preocupémonos de eso. Haz esto, y tendré el pago listo para ti."
lang["#MISSION_REDMAN_NATURALREMEDIES_HINT"] = "Obtén Raíz de Xander y Flores de Broc. Ambas plantas se pueden encontrar en lugares poco conocidos."
lang["#MISSION_REDMAN_NATURALREMEDIES_COMPLETE"] = "Aquí está su pago. Gracias por conseguir los ingredientes."

lang["#MISSION_REDMAN_HYDRATION"] = "Hidratación"
lang["#MISSION_REDMAN_HYDRATION_DESC"] = "Muy bien, esto debería ser bastante fácil. Necesitamos agua embotellada para la producción de algunas cosas. No te preocupes por purificarla, nosotros nos encargaremos de eso. Unas cuantas deberían ser suficientes. Cómo las consigas no me importa, siempre y cuando las consigas."
lang["#MISSION_REDMAN_HYDRATION_HINT"] = "Obtener agua sucia. Puedes obtener agua sucia si tienes una botella vacía y vas a una fuente de agua. También puedes obtenerla rebuscando en la basura."
lang["#MISSION_REDMAN_HYDRATION_COMPLETE"] = "Aquí está su pago. Enviaré estos en su camino."

lang["#MISSION_REDMAN_SCRAPBOOK"] = "Libro de Recortes"
lang["#MISSION_REDMAN_SCRAPBOOK_DESC"] = "Tenemos algunos objetos en nuestro arsenal que necesitan ser reparados, el problema es que no tenemos suficiente chatarra para terminar de repararlos todos. Si no te importa conseguir algo de chatarra para que podamos terminar con las reparaciones, haré que te envíen algo de dinero."
lang["#MISSION_REDMAN_SCRAPBOOK_HINT"] = "Obtener chatarra. Puedes conseguir fácilmente chatarra desguazando vehículos averiados o rompiendo artículos obsoletos en un banco de trabajo."
lang["#MISSION_REDMAN_SCRAPBOOK_COMPLETE"] = "Aquí. Esto debería ser suficiente para el resto de las reparaciones."

-- T2

lang["#MISSION_REDMAN_EXTERMINATION"] = "Exterminación"
lang["#MISSION_REDMAN_EXTERMINATION_DESC"] = "Tengo una tarea más difícil para ti. No es tan difícil, pero tenemos algunos necrófagos salvajes moviéndose en esta zona y están siendo una molestia para los comerciantes y las patrullas. Me gustaría que fueras a eliminarlos. Vuelve aquí cuando hayas terminado, tendré una recompensa decente para ti."
lang["#MISSION_REDMAN_EXTERMINATION_HINT"] = "Elimina cualquier tipo de necrófago salvaje en Salt Wells. Puedes encontrar grupos de ellos al otro lado del puente y por el camino a la ciudad donde aceptaste esta misión."
lang["#MISSION_REDMAN_EXTERMINATION_COMPLETE"] = "Aquí tienes. Ahora debería haber menos problemas por aquí."

lang["#MISSION_REDMAN_HUNTINGSEASON"] = "Temporada de Caza"
lang["#MISSION_REDMAN_HUNTINGSEASON_DESC"] = "Esto no es tanto un trabajo real como un favor que necesito que me hagas. Como tenemos muchos gekkos en esta zona, solemos ir a cazarlos de vez en cuando. El problema es que estoy atrasado con algunos trabajos aquí que necesito hacer, así que quería saber si estás dispuesto a ayudar a cubrirme mientras resuelvo las cosas aquí. Tendré lo que me paguen por ello listo para ti."
lang["#MISSION_REDMAN_HUNTINGSEASON_HINT"] = "Elimina cualquier tipo de Gekkos en Salt Wells. Se pueden encontrar en grandes áreas abiertas o bajando la colina desde donde aceptaste esta misión."
lang["#MISSION_REDMAN_HUNTINGSEASON_COMPLETE"] = "¡Gracias por cubrirme! Aquí está tu pago."

-- T3

lang["#MISSION_REDMAN_SIMPLEPRODUCTION"] = "Producción Simple"
lang["#MISSION_REDMAN_SIMPLEPRODUCTION_DESC"] = "Esta tarea puede ser un poco más difícil para tu nivel de experiencia pero tengo confianza en ti y tú también deberías tenerla. No hace mucho tiempo enviamos un grupo a la fábrica abandonada que no está muy lejos de aquí, principalmente para despejarla y ver si podíamos hacer que algunas personas empezaran a trabajar en la producción de suministros allí. Desgraciadamente, se activó una antigua seguridad y también los Protectrones que estaban allí dentro. Uno de los miembros del grupo resultó herido pero consiguieron salir bien. Sé que es pedirte demasiado pero necesito tu ayuda para destruir a esos protectrones y poder establecer un puesto de avanzada allí. Tendré un gran pago listo para ti si quieres hacerlo."
lang["#MISSION_REDMAN_SIMPLEPRODUCTION_HINT"] = "Elimina cualquier tipo de Protectron en la fábrica de Salt Wells. La fábrica está a las afueras de la ciudad, al otro lado del puente en el lado izquierdo de la carretera."
lang["#MISSION_REDMAN_SIMPLEPRODUCTION_COMPLETE"] = "Buen trabajo, $playername. Aquí tienes tu pago como se te prometió.º"

lang["#MISSION_REDMAN_BROKENMACHINE"] = "Máquina Rota"
lang["#MISSION_REDMAN_BROKENMACHINE_DESC"] = "Después de que despejaras la fábrica enviamos un grupo de hombres allí y tratamos de hacer funcionar una de las máquinas. Al parecer faltaban algunos materiales básicos, probablemente tomados por antiguos carroñeros. Me pregunto si estás dispuesto a recuperar algunos de esos materiales para nosotros."
lang["#MISSION_REDMAN_BROKENMACHINE_HINT"] = "Obtén cableado de cobre, propano, cinturones de cuero y chatarra. El cableado de cobre y el propano se pueden encontrar rebuscando o comprándolos a los comerciantes. Los cinturones de cuero se pueden encontrar rebuscando, fabricando o comprando a comerciantes. La chatarra se puede encontrar desguazar, rebuscando, rompiendo objetos o comprándola a comerciantes."
lang["#MISSION_REDMAN_BROKENMACHINE_COMPLETE"] = "Gracias por conseguir estos materiales. Aquí está su pago."

-- T4

lang["#MISSION_REDMAN_OLDFRIEND_SEARCH"] = "Buscando a un Viejo Amigo"
lang["#MISSION_REDMAN_OLDFRIEND_SEARCH_DESC"] = "Quiero saber si estás dispuesto a ayudarme con otra situación no relacionada con nada de lo que está ocurriendo aquí actualmente. Hace un tiempo había un hombre que venía frecuentemente a la ciudad. Ya sabes, la persona básica que venía a trabajar y que ayudaba a hacer las cosas. Una cara muy amable. Su nombre es Jackson, pero la razón por la que saco esto a colación es porque no ha aparecido por aquí últimamente y ninguno de los comerciantes ambulantes lo ha visto. Sólo quiero asegurarme de que está bien. Algunos de los comerciantes dijeron que pasaba mucho por la cantera. Supongo que puede vivir en la choza de ahí abajo. Quiero que vayas a comprobarlo, que te asegures de que no está herido ni corre ningún peligro."
lang["#MISSION_REDMAN_OLDFRIEND_SEARCH_HINT"] = "Busca a Jackson. Se le veía habitualmente por la cantera. Puede que viva en la choza que hay dentro. "
lang["#MISSION_REDMAN_OLDFRIEND_SEARCH_COMPLETE"] = "¿No está allí pero esta nota sí?"

lang["#MISSION_REDMAN_OLDFRIEND_TRACKS"] = "Pistas de un Viejo Amigo"
lang["#MISSION_REDMAN_OLDFRIEND_TRACKS_DESC"] = "Así que no estaba allí, hmm. Vamos a echar un vistazo a esta nota rápidamente. Dice que se reunió con un grupo hace unos días y le pidieron ayuda un lugar en las montañas donde hay muchos problemas. Es bueno saber que está bien pero aún es posible que este grupo le haya mentido o engañado así que sólo quiero garantizar su seguridad. Sé que esto puede ser un viaje largo, pero quiero que lo sigas y vayas a ver a este 'grupo' suyo. Asegúrate de que está a salvo. Por seguridad, toma este papel para que sepa que te envié yo en caso de que piense que lo estabas siguiendo con intenciones maliciosas."
lang["#MISSION_REDMAN_OLDFRIEND_TRACKS_HINT"] = "Encuentra a Jackson y dale la nota. La última vez dijo que iba a las Montañas (Yolla Bolly) con el fin de ayudar a otro grupo de personas."
lang["#MISSION_REDMAN_OLDFRIEND_TRACKS_COMPLETE"] = "Gracias por viajar hasta allí para ver cómo está. Me hubiera gustado saber sus planes antes de desaparecer."

lang["#MISSION_REDMAN_VAULTEXPEDITION_PREPARATION"] = "Expedición al bunker: Preparación"
lang["#MISSION_REDMAN_VAULTEXPEDITION_PREPARATION_DESC"] = "Espero que estés preparado para una tarea difícil ahora. Hace unas horas un grupo descubrió un regufio no muy lejos de aquí. Intentaron entrar pero aparentemente el refugio está infestado de necrófagos salvajes. Estoy dispuesto a pagar mucho si eres capaz de eliminar todos los engendros que se esconden ahí dentro. Sin embargo, no quiero enviarte a una misión suicida. Si vas a ir entonces ve preparado. Quiero que reúnas algunas provisiones y vuelvas aquí cuando creas que tienes suficientes. ¡Oh! Trae algo de dinero también. Voy a conseguir algo de munición para ti."
lang["#MISSION_REDMAN_VAULTEXPEDITION_PREPARATION_HINT"] = "Obtén estimulantes, Radaway y Dólares RNC. Los estimulantes y el Radaway pueden ser recogidos, fabricados o comprados a los comerciantes. Los Dólares RNC se pueden obtener vendiendo objetos a los comerciantes o completando trabajos."
lang["#MISSION_REDMAN_VAULTEXPEDITION_PREPARATION_COMPLETE"] = "Muy bien, pareces estar listo. Aquí está tu munición también."

lang["#MISSION_REDMAN_VAULTEXPEDITION_CLEARANCE"] = "Expedición al bunker: Limpieza"
lang["#MISSION_REDMAN_VAULTEXPEDITION_CLEARANCE_DESC"] = "¿Crees que estás listo ahora, morador del Yermo? Ve cuando te apetezca, estaré esperando tu regreso. No hagas que te maten."
lang["#MISSION_REDMAN_VAULTEXPEDITION_CLEARANCE_HINT"] = "Elimina cualquier tipo de necrófagos en el refugio de Salt Wells. El refugioa se puede encontrar fuera de la ciudad, a través del puente, hacia abajo en el pozo gigante y al lado de la colina de donde aceptó esta misión."
