...
lang["#ROCKET_DESC"] = "Peyote with the extra kick of Nuka! And some laundry detergent too. Hits harder than Peyote but doesnt last as long."
...
lang["#T45DBLUEPRINT_DESC"] = "T-45D Blueprint. Used in crafting a set of T-45D Power Armor." -- NEED (proper) DESC
...
lang["#VAULTSTEELREFININGDATA_DESC"] = "This holotape contains data on a single technique of vault steel refining. While not included here, it is implied that there are other known techniques developed by Vault-Tec." -- NEEDS DESC
...
lang["#VAULTSTEELIMPURE_DESC"] = "Impure Chromium Blade. It would need to be processed in the foundry before it would yield pure metal that can be used for crafting. " -- NEEDS (proper) DESC
...
lang["#SCREWDRIVER_DESC"] = "Screwdriver.\n\n Used in the crafting of some items." -- DESC
...
lang["#LASERBLUEPRINTSTOCK_DESC"] = "The blueprint for a Standard Laser Rifle Stock." -- NEED (proper) DESC
lang["#LASERBLUEPRINTBARREL_DESC"] = "The blueprint for a Laser Rifle Barrel." -- NEED (proper) DESC
...
lang["#ROBCOOFFICEKEY_DESC"] = "RobCo Office Key. Used to unlock a door somewhere." -- NEED (proper) DESC
...
lang["#BOBBLEHEADSMALLGUNS_NAME"] = "Small Guns Bobblehead"
lang["#BOBBLEHEADSMALLGUNS_DESC"] = "Small Guns Bobblehead." -- NEEDS DESC
