...
lang["#POWERARMORREPAIR_NAME"] = "Power Armor Repair Kit"
...
lang["#POWERARMORREPAIR_DESC"] = "A small kit containing a variety of high end tools used for the maintenance and repair of your typical piece of power armor. Extremely rare and even more useful, though you'll only be able to use the contents of it for a singular piece of power armor.\n\nCan be used to Repair T45, T51 and Brotherhood Power Armor"
