...
lang["#MOD_BARREL_LGUN_ULTIMA"] = "Ultima Rifle Barrel"
...
lang["#MOD_SIGHT_ALIENBLASTER_DESC"] = "What appears to be a scope for the Alien Blaster.\n\nApparently, aliens don't have excellent vision either."
lang["#MOD_SIGHT_ALIENDISINTEGRATOR_DESC"] = "A simple collimator sight for the Alien Disintegrator.\n\nFor when you don't want to have to boresight a priceless piece of xenotech."
lang["#MOD_SIGHT_GAUSSMINIGUN_DESC"] = "An improved sight for the Gauss Minigun.\n\nOffers a superior visual profile to iron sights. 1.0x magnification."
...
lang["#MOD_BARREL_STANDARD_ALIENDISINTEGRATOR_DESC"] = "A longer, heavier barrel for the Alien Disintegrator.\n\nOffers superior range and projectile speed." 
lang["#MOD_BARREL_AUTOMATIC_ALIENDISINTEGRATOR_DESC"] = "A sturdy barrel for the Alien Disintegrator.\n\nMakes an already dangerous weapon even more lethal.\n\nSwitches fire mode to automatic."
lang["#MOD_BARREL_SHORT_ALIENDISINTEGRATOR_DESC"] = "A short, carbine length barrel for the Alien Disintegrator\n\nFor when you need disintegrations in a smaller package."
lang["#MOD_BARREL_SPLITTER_ALIENDISINTEGRATOR_DESC"] = "A complex barrel for the Alien Disintegrator.\n\nSplits a single projectile into multiple 'pellets,' turning the weapon into an ad hoc shotgun.\n\nOuch."
lang["#MOD_BARREL_SNIPER_ALIENDISINTEGRATOR_DESC"] = "A long, precise barrel for the Alien Disintegrator.\n\nA much desired increase in velocity creates an even more dangerous ball of... whatever the aliens use."
lang["#MOD_BARREL_LOBBER_ALIENDISINTEGRATOR_DESC"] = "A heavy-duty barrel for the Alien Disintegrator.\n\nTurns the weapon into an improvised grenade launcher.\n\nAs if the main product wasn't already scary enough."
lang["#MOD_BARREL_AUTO_PCASTER_DESC"] = "An automatic barrel conversion for the Plasma Caster.\n\nSignificantly increases the speed of bolt formation process, making the plasma caster automatic."
lang["#MOD_BARREL_SCATTER_PCASTER_DESC"] = "A scatter barrel conversion for the Plasma Caster.\n\nSplits the bolts into multiple 'pellets,' converting the weapon into a scattergun.\n\nDevastating at close range."
lang["#MOD_BARREL_SNIPER_PCASTER_DESC"] = "A heavy barrel conversion for the Plasma Caster.\n\nStronger electromagnetic stabilizers means a heavier plasma bolt, which means more pain sent toward whatever you want dead."
...
lang["#MOD_BARREL_HUNTINGREV_FLUTED_DESC"] = "A heavy barrel for the Hunting Revolver.\n\nThe added mass and surface area of the barrel yield a tighter group downrange than its normal cousin. The fluting on the barrel reduces weight without compromising integrity.\n\nNow you're truly ready to hunt." 
lang["#MOD_BARREL_HUNTINGREV_LONG_DESC"] = "A long barrel for the Hunting Revolver.\n\nIncreased barrel length leads to increased muzzle velocity, which leads to rather bad cases of dead for whoever is on the receiving end."
lang["#MOD_BARREL_SSWEEPER_METAL_DESC"] = "A stamped handguard for the Street Sweeper.\n\nCrude but effective and strong, just like its creators."
lang["#MOD_BARREL_SSWEEPER_POLYMER_DESC"] = "A pre-war manufactured handguard for the Street Sweeper.\n\nYou don't know the exact model of shotgun this originally came from, but it doesn't seem to be American."
lang["#MOD_BARREL_SSWEEPER_LONG_DESC"] = "A lengthy and heavy barrel for the Street Sweeper.\n\nFor when you need to clear blocks instead of streets."
...
lang["#MOD_BARREL_ALIENBLASTER_DESC"] = "An extra long barrel for the Alien Blaster.\n\nGives the blaster some much needed velocity, in case you wanted to hit something going faster than erosion."
lang["#MOD_BARREL_LONG_4.7MM_DESC"] = "A longer, reinforced barrel for the Vindicator.\n\nMore accurately, six longer and reinforced barrels. Increased muzzle velocity makes 4.7mm even more lethal than it already was."
lang["#MOD_BARREL_LONG_QUAD_4.7MM_DESC"] = "A set of longer barrels and matching housing for the Vindicator.\n\nSix barrels is too many. Four is just right."
lang["#MOD_BARREL_SHORT_QUAD_4.7MM_DESC"] = "A set of cut-down barrels for the Vindicator.\n\nBest suited to close range combat, such as in bunkers or urban fighting.\n\nIf you're that close, perhaps such a heavy weapon wasn't a good idea to begin with."
...
lang["#MOD_BARREL_HMGUN_LONG_DESC"] = "An extended barrel for the T-24 machine gun.\n\nSmaller barrels tend to overheat and melt under sustained firing. A longer, reinforced barrel solves that problem."
...
lang["#MOD_BARREL_MARKSMAN_LONG_DESC"] = "A long barrel for the Marksman Pistol.\n\nA longer barrel offers better velocity, and is therefore better suited to the kind of hunting the pistol was meant for."
lang["#MOD_BARREL_MARKSMAN_MEDIUM_DESC"] = "A slightly longer barrel for the Marksman Pistol.\n\nNot too long as to be cumbersome, but not too short as to be innacurate."
lang["#MOD_BARREL_GAUSSMINIGUNTRI_DESC"] = "A tri-barrel housing for the Gauss Minigun.\n\nHow do you make 2mm EC even scarier than it already is? Make it fire three times as fast."
lang["#MOD_BARREL_GAUSSMINIGUNPENTA_DESC"] = "A penta-barrel housing for the Gauss Minigun.\n\nFurther increases fire rate with the addition of even more barrels.\n\nGuess three wasn't enough, huh?"
lang["#MOD_BARREL_VSK_SNIPER_DESC"] = "A long barrel for the VSK marksman rifle.\n\nMarkings on the barrel suggest it wasn't created in America."
...
lang["#MOD_MAG_M72_DESC"] = "A cylindrical drum magazine for the M72.\n\nIf you need this many shots to go into one target, you're probably going to need a Fat Man."
lang["#MOD_MAG_4.7MM_DESC"] = "An extra-large drum magazine for the Vindicator.\n\nNow you can kill even more muties before having to reload!"
lang["#MOD_MAG_SSWEEPER_EXTENDED_DESC"] = "An extra-large magazine for the Street Sweeper.\n\nHold on a minute, isn't this just a bunch of regular magazines welded together?"
lang["#MOD_MAG_SSWEEPER_DRUM_DESC"] = "A cylindrical drum magazine for the Street Sweeper.\n\nWith some creative--read, destructive--modifications to a T24 ammo drum, it can hold shotgun shells.\n\nFor when you need to sweep the whole city."
...
lang["#MOD_GRIP_HUNTINGREV_COMFORT_DESC"] = "An ergonomic grip for the Hunting Revolver.\n\nFits the hand more naturally than the factory grip and is more ergonomic."
lang["#MOD_GRIP_HUNTINGREV_IVORY_DESC"] = "A hand-carved ivory grip for the Hunting Revolver.\n\nStill has its shine after centuries. Whatever animal this came from is probably extinct."
lang["#MOD_GRIP_HUNTINGREV_MAHOGANY_DESC"] = "A hand-carved mahogany grip for the Hunting Revolver.\n\nExquisite and rare, both a status symbol and a boon. A true work of art."
...
lang["#MOD_GRIP_IMPROVED_ALIENBLASTER_DESC"] = "A modified grip for the Alien Blaster.\n\nMore suitable for the human hand than the alien one. Significantly more comfortable to hold."
lang["#MOD_GRIP_COMFORT_ALIENBLASTER_DESC"] = "An ergonomic gripf or the Alien Blaster.\n\nHolding the thing no longer causes cramping in your fingers. Neat!"
...
lang["#MOD_GRIP_MARKSMAN_POLY_DESC"] = "A polymer grip for the Marksman Pistol.\n\nNot as pretty as hand-carved wood, but lighter and easier to replace."
lang["#MOD_STOCK_GAUSSRIFLE_DESC"] = "A heavier stock for the Gauss Rifle.\n\nBetter recoil control, better comfort, increased weight. It'll do."
lang["#MOD_GRIP_STANDARD_ALIENDISINTEGRATOR_DESC"] = "A full rifle stock for the Alien Disintegrator.\n\nThe thing doesn't have much recoil to begin with, but every little bit helps."
lang["#MOD_GRIP_MARKSMEN_ALIENDISINTEGRATOR_DESC"] = "A reinforced rifle stock for the Alien Disintegrator.\n\nFurther dampens recoil and looks nicer to boot!"
lang["#MOD_STOCK_M72_BASIC_DESC"] = "A crude, handmade stock for the M72 Gauss Driver.\n\nIt's better than nothing, at least."
lang["#MOD_STOCK_M72_LIGHT_DESC"] = "A lightweight, manufactured stock for the M72 Gauss Driver.\n\nSuitable for paratroopers or vehicle crews. Why either of them need a gauss weapon is anyone's guess."
...
-- Descriptions
lang["#MOD_PCUTTER_BLADE_UNSTABLE_DESC"] = "A set of unstable projectors for the Plasma Cutter.\n\nImproperly shielded projectors create a stronger blade, but a tempermental one.\n\nPlease don't drop it."
lang["#MOD_PCUTTER_BLADE_HEAVY_DESC"] = "A set of heavy duty projectors for the Plasma Cutter.\n\nIdeal for industrial uses, such as breaking apart old cars or hacking off limbs and heavy armor."
lang["#MOD_PCUTTER_BLADE_SUPERHEATED_DESC"] = "A set of focused projectors for the Plasma Cutter.\n\nIncreasing the focus of the beam increases its temperature, and therefore its lethality."
lang["#MOD_PCUTTER_BLADE_OVERCLOCK_DESC"] = "A set of optimized projectors for the Plasma Cutter.\n\nModified to get just a bit of extra juice from the cutter without extra danger. An all around improvement."
