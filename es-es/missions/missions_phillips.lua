...
lang["#MISSION_PHILLIPS_RESPECTS_ITEMNAME"] = "Fallen Ranger's Teddy Bear"
...
lang["#MISSION_PHILLIPS_DEATHCLAW"] = "The Bigger they are..."
lang["#MISSION_PHILLIPS_DEATHCLAW_DESC"] = "Now that your a Desert Ranger it's time I let you in a little secret. We have a weapon that's been passed down from generation to generation of rangers and if you can prove that you have skill with even with its lesser counterpart then we will bestow this weapon upon you. The hunters choice of pistol, The Hunting Revolver is a firearm of high caliber and higher class. She kicks like a Donkey and hits like Brahmin. This thing can bring down anything from a simple Bandit to a mighty Deathclaw. And your gonna prove it by hunting and slaying the Deathclaws plaguing these mountains. Thin the herds of these bastards then report back to me for the second part of the trial."
lang["#MISSION_PHILLIPS_DEATHCLAW_HINT"] = "Kill 40 Deathclaws with a Hunting Revolver in Yolla Bolla Mountain Range."
lang["#MISSION_PHILLIPS_DEATHCLAW_COMPLETE"] = "That's some damn fine work, $playername. Damn Fine work you did. Now that you've gotten to know the gun and how to handle her its time to put your skills up to the test. We are gonna take out the source of these damn abominations."

lang["#MISSION_PHILLIPS_SEQUIOA"] = "...The Harder They Fall"
lang["#MISSION_PHILLIPS_SEQUIOA_DESC"] = "As I said previously, You have proven you've got the talent. But I need you to put those skills to the test. We need you to wipe out the Matriarch's that are spawning these wasteland horrors. Kill 'em anywhere, doesn't matter. Just make sure to use the Hunting Revolver when you put them down."
lang["#MISSION_PHILLIPS_SEQUIOA_HINT"] = "Kill 10 Deathclaw Matriarchs with a Hunting Revolver."
lang["#MISSION_PHILLIPS_SEQUIOA_COMPLETE"] = "Excellet job ranger. With their numbers thinned and the threat neutralized, it should be quite some time before they threaten us again. And with that you have completed all that has been asked of you. I hand over this weapon to you with pride and honour. Treat the Sequioa well and it will save your life."

lang["#MISSION_PHILLIPS_FRONTIER"] = "On The Frontier"
lang["#MISSION_PHILLIPS_FRONTIER_DESC"] = "Now that you have the true firearm of a Desert Ranger I'm sure your eager to test it out. Lucky for you I've got just the target. Rumors of a Deathclaw of mythical stature have been confirmed by some scouts recently. Unguem Mortis. Whatever the hell that means, hes deadly. He's already killed a few Rangers so consider him deadly. I'd recommend gathering ateam before taking him on. The Rangers that went it alone are already six feet below. Put that abomination down with some frontier justice."
lang["#MISSION_PHILLIPS_FRONTIER_HINT"] = "Kill Unguem Mortis with the Ranger Sequoia. They can rarely show up in the Ashlands region."
