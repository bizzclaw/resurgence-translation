...
lang["#WIPWARN_TITLE"] = "Resurgence 当前处于 Beta 阶段"
lang["#WIPWARN_SUB"] = "你将会遇到 BUG 和未完成的内容"
lang["#UI_ANYKEY"] = "按任意键开始"
...
lang["#UI_SELCHAR"] = "选择角色"
lang["#UI_LOADCHAR"] = "加载角色"
lang["#UI_NEWCHAR"] = "创建角色"
lang["#UI_DELCHAR"] = "删除角色"

--主菜单
lang["#UI_STARTPLAYING"] = "开始游玩"
lang["#UI_RESUME"] = "返回游戏"
lang["#UI_SETTINGS"] = "设置"
lang["#UI_STEAMGROUP"] = "Steam 组"
lang["#UI_GMODMENU"] = "Garry's Mod 菜单"
lang["#UI_SIGNOUT"] = "Resurgence 主菜单"
lang["#UI_QUIT"] = "断开连接"
...
-- Shorthands
lang["#SHORT_HP"] = "生命值" -- Health Points
lang["#SHORT_AP"] = "行动点数" -- Action Points
lang["#SHORT_DMG"] = "伤害" -- Damage
lang["#SHORT_CXP"] = "战斗经验" -- Combat Experience
lang["#SHORT_UXP"] = "全局经验" -- Utility Experience
lang["#SHORT_LMB"] = "LMB" -- Limb Health
lang["#SHORT_SPECIAL"] = "SPECIAL" -- Special
lang["#SHORT_TIME"] = "时间" -- Time
lang["#SHORT_WGT"] = "WGT" -- shorthand for "weight"
lang["#SHORT_SWGT"] = "SAVE WGT" -- shorthand for "weight"
lang["#SHORT_DT"] = "伤害极限" -- Damage Threshold
lang["#SHORT_STR"] = "STR" -- Strength
lang["#SHORT_CND"] = "状态" -- Condition
lang["#SHORT_RADS"] = "辐射" -- Radiation level
...
lang["#UI_EMPTYSTORAGE"] = "<空>"
lang["#UI_ETAKE"] = "@+use 拿走"
lang["#UI_EUSE"] = "@+use 使用"
lang["#UI_RTAKEALL"] = "@+reload 拿走全部"
lang["#UI_FMOUSE"] = "@impulse 100|Mouse"
lang["#UI_PERKPOINTS"] = "技能点"
lang["#UI_BACK"] = "返回"
lang["#UI_YES"] = "是"
lang["#UI_NO"] = "否"
...
--ToolTips
lang["#TOOLTIP_RELOAD"] = "@+reload 装填弹药。"
lang["#TOOLTIP_AIM"] = "@+attack2 瞄准"
lang["#TOOLTIP_OPENDOOR"] = "@+use 开门。"
lang["#TOOLTIP_DRINK"] = "@+use 喝。"
lang["#TOOLTIP_LOOT"] = "@+use 打开"
lang["#TOOLTIP_TALK"] = "@+use 交谈"
lang["#TOOLTIP_DRIVE"] = "@+use 驾驶"
lang["#TOOLTIP_BOARD"] = "@+use 坐下" -- entering vehicle seats
...
lang["#CHARMAKE_HAIR"] = "头发"
lang["#CHARMAKE_HAIRSTYLE"] = "发型"
lang["#CHARMAKE_HAIRCOLOR"] = "头发颜色"
lang["#CHARMAKE_HAIRSAT"] = "Hair Saturation"
lang["#CHARMAKE_HAIRBRIGHT"] = "头发亮度"
lang["#CHARMAKE_GENDER"] = "性别"
lang["#CHARMAKE_RACE"] = "种族"
lang["#GENDER_MALE"] = "男性"
lang["#GENDER_FEMALE"] = "女性"
lang["#CHARMAKE_DISCARDCHAR"] = "This will reset your character data. Continue?"
lang["#UI_NAMECHARACTER"] = "完成角色创建"
lang["#UI_ENTERNAME"] = "输入名称..."
...
-- Statistics
lang["#STAT_TIMEPLAYED"] = "已游玩时间"

-- Settings

lang["#SETTING_PIPCOL"] = "哔哔小子颜色"
lang["#SETTING_HUDCOL"] = "HUD 颜色"
lang["#SETTING_BADCOL"] = "Bad Color"
lang["#SETTING_GUDCOL"] = "Good Color"

lang["#SETTING_AMBIENT_MUSIC"] = "环境音乐音量"
lang["#SETTING_COMBAT_MUSIC"] = "战斗音乐音量"
lang["#SETTING_RADIO_MUSIC"] = "收音机音乐音量"
lang["#SETTING_FOV"] = "Field Of View (Unsighted)" -- imply that the field of view settings does not affect aiming zoom.
lang["#SETTING_PIPSPEED"] = "哔哔小子光标灵敏度"
lang["#SETTING_VIEWBOB"] = "视角抖动倍率"
...
lang["#SETTING_TOGGLEAIM"] = "武器切换瞄准"
lang["#SETTING_CROSSHAIR"] = "启用准心"
...
-- Contracts
lang["#MISSION_ACCEPT"] = "接受任务"
lang["#MISSION_TURNIN"] = "Turn In"
lang["#MISSION_COMPLETE"] = "已完成。"
lang["#MISSION_KILLS"] = "击杀数"
lang["#MISSION_SELECTREWARD"] = "你已完成任务。选择一个奖励。"
