...
lang["#TUTORIAL_NEARDEATH"] = "Вы при смерти!\n\nЕщё один такой удар, и вы умрёте, если не вылечите свои раны."
...
Слегка увеличенный ПЕРС и ИНТЕЛЕКТ. Слегка меньшены ВНС и СИЛ.
...
Слегка увеличенный ИНТЕЛЕКТ. Слегка уменьшена ВНС.
Невосприимчив к радиации. Она также лечит вас. Когда ваш уровень РАД высок, вы получаете положительный эффект для своей ВНС.
...
Вы не можете одеть обычную человеческую броню и должны иметь индивидуальную одежду. Вы не можете использовать определённое оружие.
