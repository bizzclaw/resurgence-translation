...
lang["#UI_UNSTUCKWAIT"] = "Подождите $time секунд, прежде чем вы сможете использовать unstuck снова."
lang["#UI_UNSTUCKFAILED"] = "Unstuck провалился! Попробуйте связаться с администратором, поставив @ перед вашим сообщением!"
...
lang["#TUTORIAL_ARMORCOVERAGE"] = "Вы одели часть одежды!\n\nНекоторые части одежды предоставляют броню против определённых типов урона\n\nВАЖНО: Броня может защитить ТОЛЬКО ту часть тела, которую она покрывает!"
lang["#TUTORIAL_NEARDEATH"] = "Вы при смерти!\n\nЕщё один такой удар, и ты навсегда падёшь, если не будешь лечить свои раны."
...
Стандартная статистика SPECIAL- нет негативных эффектов, нет усилений.
...
Слегка увеличенный ПЕРС и ИНТЕЛЕКТ. Слегка меньшие ВНС и СИЛ.
...
Слегка увеличенный ИНТЕЛЕКТ. Слегка уменьшен ВНС.
Невосприимчив к радиации. Она также лечит тебя. Когда ваш уровень РАД высок, вы получаете положительный эффект для своей ВНС.
Когда-то вы были людьми, но в какой-то момент вы подвергались смертельной дозе радиации. Возможно, вы были на пробежке, и в вашем костюме с радиантом произошла утечка, возможно, вы упали в большой кратер и решили вздремнуть, или, возможно, вы даже находились рядом, пока не упали бомбы. Вы может даже не помните. Как бы то ни было, вы выжили благодаря некоторой генетической причуде, и теперь вы стали этим... созданием.
]]

lang["#RACE_SUPERMUTANT_DESC"] = [[
Значительно увеличена СИЛ и ВНС. Значительно снижен ИНТЕЛЕКТ и ПЕРС. Слегка уменьшен ЛОВ и УДЧ.
Невосприимчив к радиации. Она также влияет на вас по-разному в зависимости от уровня РАД. Высокие дозы радиации слегка увеличивают вашу СИЛ и ВНС, в то же время слегка ослабляя ИНТЕЛЕКТ и ПЕРС.
Не может одеть обычную человеческую броню и должны иметь индивидуальную одежду. Не может использовать определенное оружие.
...
Быть гулем не так уж и плохо. С одной стороны, вы, кажется, больше не стареете. Вы также полностью невосприимчивы к радиации и даже исцелены ею. Вы обнаружили, что чем больше вы облучены, тем сильнее вы себя чувствуете. Однако, из-за вашей шелушащейся и кожистой кожи, вы немного слабее, чем обычная гладкая кожа. Тем более, когда у тебя не было своей радиации. Дикие гули также, кажется, игнорируют вас.
