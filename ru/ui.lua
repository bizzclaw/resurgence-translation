...
lang["#UI_TELEPORTERBLOCK_FACTION_FAVOR"] = "У вас не достаточно пользы у данной организации, чтобы войти: $faction.\n\nВам нужно: $favorRequired\nВы имеете: $favorCurrent\n\nПолучите пользу, выполняя задания организации: $faction."
...
lang["#UI_PERKPOINTGAINED"] = "Вы получили очко S.P.E.C.I.A.L, которое можно потратить!\n\nПроверьте раздел SPECIAL в вашем пип-бое, чтобы увеличить атрибуты вашего персонажа."
...
lang["#NOTIFY_ROLLED"] = "[ROLL] $person получает случайное число: $number."
lang["#NOTIFY_YOUROLLED"] = "[ROLL] Вы получили случайное число: $number."
...
lang["#INV_REMOVEDMULTI"] = "$item|s ($count) - предмет удалён"
...
lang["#TRADE_NOTRADE"] = "Вы не можете обменять этот предмет!"
...
lang["#CHARMAKE_CHARACTERLIMIT"] = "Вы достигли предела персонажей."
...
lang["#MISSIONREWARD_REPUTATIONDESC"] = "Примите меньшую награду за выполнение этой миссии, чтобы получить больше пользы у этой организации."
...
lang["#COMMUNITY_NAMETAKEN"] = "Имя уже используется"
...
lang["#COMMUNITY_PERM_EDIT_MEMBER"] = "Изменение участника"
...
lang["#COMMUNITY_PERM_ASSGN_RANKS_DESC"] = "Добавить/удалить пользователей, занимающих места ниже нашего - на места ниже нашего."
...
lang["#COMMUNITY_RANK_INVALID_NAME"] = "Ранг не может быть обновлён - название недействительно."
...
lang["#INFLUENCE_NOTE_MISSION"] = "Награда за миссию"
