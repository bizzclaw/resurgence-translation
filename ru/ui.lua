...
lang["#MISSION_ACCEPT_ONHOSTILE"] = "ПРИНЯТИЕ МИССИИ ОТ ВРАЖДЕБНОЙ ФРАКЦИИ!\n\nПриняв эту миссию, эта фракция станет нейтральной по отношению к вам, и больше не будет нападать на вас без предупреждения\n\nНАПАДЕНИЕ НА НИХ ПОВЛЕЧЁТ ЗА СОБОЙ ПРЕСТУПЛЕНИЕ!"
