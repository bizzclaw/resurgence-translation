...
lang["#UI_SAVEWEIGHT"] = "Сохранить ВЕС" -- shorthand for "weight"
lang["#SHORT_DT"] = "ПУ"
lang["#UI_EMPTYSTORAGE"] = "<Пусто>"
lang["#UI_ETAKE"] = "Взять"
lang["#UI_RTAKEALL"] = "Взять всё"
lang["#UI_FMOUSE"] = "@impulse 100|Мышь"
lang["#PROTECTION_TIMEBLOCK"] = "Сохранение заблокировано\n\nВы должны подождать, прежде чем сохранить этот элемент!\n\n"
lang["#PROTECTION_NOTENOUGHWGT"] = "Невозможно сохранить, недостаточно Бюджета для Сохранения веса.\n\nВаш бюджет сохранении веса основан на вашем навыке Сохранение веса."
...
lang["#UI_RECYCLING"] = "Утилизировать"
...
lang["#NOTIFY_OVERECUMBERED_1"] = "Вы несете слишком много и движетесь медленнее."
lang["#NOTIFY_OVERECUMBERED_2"] = "Вы несете слишком много и больше не можете бежать."
lang["#NOTIFY_OVERECUMBERED_3"] = "Вы несете слишком много и больше не можете двигаться."
lang["#NOTIFY_TOFARTOTRADE"] = "Цель слишком далеко, чтобы торговать с ней."
lang["#NOTIFY_WANTSTOTRADE"] = "Хотел бы торговать с вами. Посмотри на него и удерживай @use чтобы принять торговый запрос."
...
--PARTY
lang["#HASINVITED"] = "пригласил вас присоединиться к его отряду."
...
lang["#TUTORIAL_CRAFTING"] = "Изготовление\n\nВыберите рецепт, чтобы увидеть, что он требует и что он дает.\n\nТребования, помеченные как [Skill] Обозначивают требование к навыку\n\nТребования, помеченные как [Tool] Предметы, которые должны быть в вашем инвентаре, но не использованы.\n\nВсе остальные предметы расходуются при изготовлении."
lang["#TUTORIAL_REPAIR"] = "Починка\n\nЧтобы починить предмет, вы должны разбить об него другой предмет. Выберите предмет в списке, чтобы использовать его для ремонта.\n\nЗадержка\n\nИспользование другого экземпляра этого оружия - ваш лучший выбор, в противном случае вы можете использовать ремонтный комплект, но это добавит Задержку.\n\nЗадержка(Decay) - это множитель того, как быстро этот предмет сломается, и его нельзя уменьшить."
...
lang["#RADIO_CTDN"] = "Рассказы про темные ночи"
...
YВы родились где-то в пустоши. Вы много слышали о том, каким был мир, но мир, как вы знаете - это постоянная борьба за выживание. Наполнен мутантами, пытающимися убить тебя, и желудком, который нужно кормить.

Ты как большинство человек- людей. Прямо сейчас вы можете быть никому не важны, и, возможно, вы умрёте таким образом. В конце концов, это мир беззакония. Но кто знает? Это новое начало. Может быть, вы сделаете что-то для себя в этом хаотическом месте.

Воспитание в суровых условиях пустоши сделало вас устойчивым и немного привыкшим к конфликтам.

Неважно, в чём твоя причина, ты сам по себе. Что бы вы ни делали в своей жизни сейчас, это ваш собственный выбор.
]]
...
Вы можете выглядеть как любой другой обитатель пустошей, если вы не в своем ярко-синем костюме, но на самом деле вы немного отличаетесь на микроскопическом уровне. Ваша ДНК чиста, свободна от радиоактивных мутаций, присутствующих во всей жизни, рожденной на пустоши.

Жизнь в убежище имеет свои преимущества- вы умнее, чем средний обитатель пустошей, благодаря вашему обязательному образованию в Убежище. Тем не менее, вы можете быть немного слабым, хотя из-за отсутствия... разрастания конфликта.

По какой-то причине вы покинули убежище. Теперь вы в пустыне. Что бы вы ни делали в своей жизни сейчас, это ваш собственный выбор.
]]

lang["#RACE_GHOUL_DESC"] = [[
Когда-то вы были людьми, но в какой-то момент вы подвергались смертельной дозе радиации. Возможно, вы были на пробежке, и в вашем костюме с радиантом произошла утечка, возможно, вы упали в большой кратер и решили вздремнуть, или, возможно, вы даже находились рядом, пока не упали бомбы.

Вы можете даже не помните. Как бы то ни было, ты выжил благодаря некоторой генетической причуде, и теперь ты стал этим... созданием.

Люди смотрят на тебя не так, как раньше. Вас зовут "зомби" и другими унижениями. Некоторые могут даже застрелить вас, не желая рисковать. Знаешь, дикие гули были нормальны, как ты когда-то. Может быть, однажды вы тоже так закончите, если пустоши не дойдут до вас первыми.

Быть гулем не так уж и плохо. С одной стороны, вы, кажется, больше не стареете. Вы также полностью невосприимчивы к радиации и даже исцелены ею. Вы обнаружили, что чем больше вы облучены, тем сильнее вы чувствуете. Однако, из-за вашей шелушащейся и кожистой кожи, вы немного слабее, чем обычная гладкая кожа. Тем более, когда у тебя не было своей радиации.

Дикие звери также, кажется, игнорируют вас.
...
Благодаря слизи, с тобой произошло много вещей. Вы не знаете какого вы возраста, и, очевидно, вы больше и намного сильнее, чем человек. Из-за ваших огромных рук вы не можете использовать крошечное оружие, такие как пистолеты, а из-за своего размера вы не можете влезть в человеческую одежду.

Функции вашего мозга также были повреждены- даже если вы один из "умных" Супер Мутантов, вы такой же умный, как нормальный человек. Радиация влияет на вас также по-разному.
...
lang["#UI_WORLDMAPWELCOME"] = "Добро пожаловать на карту путешествия!\nНажмите в любом месте на карте, чтобы переместиться туда.\nУдерживайте правую кнопку мыши, чтобы панорамировать."
lang["#UI_WORLDMAPLOADIN"] = "Вы вошли в загружаемый регион.\nНажмите на стрелку, указывающую вниз, в вашем местоположении, чтобы войти."

-- Name`
lang["#WORLDNAME"] = "Пустошь Каскадия" -- The Pacific Northwest (Northern California to British Columbia) is nicknamed "Cascadia"

-- Statistics
lang["#STAT_TIMEPLAYED"] = "Игровое время"
