...
-- Crafting
lang["#CRAFTING_RELOADING"] = "Перезарядка станка"
...
Человек рождённый и выросший в пустоши. 

Жизнь в пустыне сделала вас более приспособленными к суровым условиям. 
]]

lang["#RACE_VAULTDWELLER_DESC"] = [[
	Описание жителя убежища идёт сюда
]]

lang["#RACE_GHOUL_DESC"] = [[
Гуль - это человек, который благодаря некоторой генетической причуде вместо того, чтобы умирать от длительного воздействия радиации, необратимо мутировал, вызывая некроз кожи, выпадение волос и внешность 'зомби'.

За гуля, вы будете получать увеличенное количество урона независимо от вашей выносливости, но вы полностью невосприимчивы к радиации. Фактически, радиация почти полностью поглотит ваш увеличенный урон, давая вам положительные эффекты для Ловкости и Силы.
]]
...
-- Name`
lang["#WORLDNAME"] = "Пограничная Пустошь"
